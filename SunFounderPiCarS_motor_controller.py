...
# SunFounder PiCar-S entwickelt. Es folgt dabei der Belegung
# der GPIO Pins am Raspberry Pi sowie der am PCA9685 Servo
# Kontroller wie von SunFounder beschrieben.
...
# SetMotorLeft(0)     -> der Motor dreht mit 0% ist gestoppt
# SetMotorLeft(0.75)  -> der Motor dreht mit 75% vorwaerts
# SetMotorLeft(-0.5)  -> der Motor dreht mit 50% rueckwaerts
# SetMotorLeft(1)     -> der Motor dreht mit 100% vorwaerts
